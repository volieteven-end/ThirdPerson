...
GENERATED_BODY()
public:
UFUNCTION(BlueprintCallable,Category="ForestUI") static FString TestLockMarker(UUserWidget* Context,bool ExpectRefined);
UFUNCTION(BlueprintCallable,Category="ForestUI") static bool RenderLockMarker(UUserWidget* Context,const FString& Filename,bool LightBackground=false);
